...
import com.wahidabd.remas.databinding.ItemChatLeftBinding
import com.wahidabd.remas.databinding.ItemChatRightBinding
import com.wahidabd.remas.utils.DateTimeUtil
...
class ChatRoomAdapter(private val id: String) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    class LeftViewHolder(private val binding: ItemChatLeftBinding) : RecyclerView.ViewHolder(binding.root){
        fun bind(data: ChatRoomResponse){
            ...
            binding.tvDate.text = DateTimeUtil.getDescriptiveMessageDateTime(data.date.toString(), true)
        }
    }
